...
if(isset($_POST['update_product'])){
    ...
    $update_query = mysqli_query($conn, "UPDATE `new_products` SET name = '$update_name', description = '$update_description', price = '$update_price', image = '$update_image' WHERE id = '$edit'");
...
?>
  ...
  <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
        ...
        <li itemprop="itemListElement" itemscope="" >
          ...
          <meta itemprop="position" content="2">
                ...
                <a class="label" href="addproducts.php">
  ...
  <?php
    ...
    if(mysqli_num_rows($edit_query) > 0){
        if($fetch_edit = mysqli_fetch_assoc($edit_query)){
...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
    ...
    <input type="text" class="box" placeholder="enter the product name" required name="update_name" value="<?php echo $fetch_edit['name']; ?>">
    <input type="text" class="box" placeholder="enter the product description" required name="update_description" value="<?php echo $fetch_edit['description']; ?>">
    <input type="number" class="box" placeholder="enter the product price" min="0" name="update_price" value="<?php echo $fetch_edit['price']; ?>">
