...
if(isset($_POST['submit'])){
   ...
   $Fullname = $name . "" . $lastname;
    ...
    if(mysqli_num_rows($select) > 0){
        ...
        $insert = mysqli_query($conn, "INSERT INTO `register`(Fullname, email, password, name, lastname, user_type) VALUES('$Fullname','$email','$pass', '$name', '$lastname', '$user_type')") or die('query failed');
...
<aside id="notifications">
  ...
  <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
        ...
        <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
          <a itemprop="item" href="registeradmin.php">
            <span itemprop="name">Register New Admin/User</span>
          </a>
