...
if(isset($_POST['update_information'])){
  ...
  $update_query = mysqli_query($conn, "UPDATE `register` SET Fullname = '$update_Fullname', name = '$update_name', lastname = '$update_lastname', email = '$update_email', password = '$update_pass' WHERE id = '$id'");
}
?>
...
display: none !important;
  ...
  <marquee><h1>ADMIN INFORMATION CAN NO BE EDITED!</h1></marquee>
  ...
  <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
        ...
        <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
          <a itemprop="item" href="admininfor.php">
            <span itemprop="name">Admin Information</span>
          </a>
...
<form action="https://connexstore.co.za/identity" id="customer-form" class="js-customer-form" method="post">
  <section>
  ...
  <div class="form-group row ">
    ...
    <div class="col-md-6">
          ...
          <input class="form-control" name="firstname" type="text" value="<?php echo $name; ?>" required="">
...
<hr class="separator">
  ...
  <a href="admindashboard.php" class="account-link">
    <i class="material-icons"></i>
    <span>Back to dashbaord</span>
  </a>
  <a href="userdisplay.php" class="account-link">
