...
if(isset($_POST['update_update_btn'])){
    ...
    $update_quantity_query = mysqli_query($conn, "UPDATE `products` SET quantity = '$update_value' WHERE id = '$update_id'");
...
if(isset($_POST['remove'])){
   ...
   /* foreach ($_SESSION as $key=>$val){
        ...
        $id = return_info($conn, 'products', 'id', 'id', $product_id_number_without_p);
        echo $id;
...
clip:auto !important;
color-scheme:light !important;}#c9ah3do2gkd81684756875061.widget-hidden {display: none !important;}#c9ah3do2gkd81684756875061.widget-visible {display: block !important;}
@media print{
 #c9ah3do2gkd81684756875061.widget-visible { 
display: none !important;
 }
}</style><style type="text/css">@keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}@-moz-keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}@-webkit-keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}#zvkot162rds1684756875119.open{animation : tawkMaxOpen .25s ease!important;}@keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}@-moz-keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}@-webkit-keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}#zvkot162rds1684756875119.closed{animation: tawkMaxClose .25s ease!important}</style><script src="https://cdn.jsdelivr.net/emojione/2.2.7/lib/js/emojione.min.js" type="text/javascript" async="" defer=""></script><script src="https://cdn.jsdelivr.net/emojione/2.2.7/lib/js/emojione.min.js" type="text/javascript" async="" defer=""></script></head><body id="cart" class="lang-en country-za currency-zar layout-full-width page-cart tax-display-enabled cart-empty live_edit_0 ps_178 no_bg #ffffff bg_attatchment_normal bg_position_tl bg_repeat_xy bg_size_initial slider_position_column slider_controls_black banners_top2 banners_top_tablets2 banners_top_phones1 banners_bottom2 banners_bottom_tablets2 banners_bottom_phones1 submenu1 pl_1col_qty_5 pl_2col_qty_5 pl_3col_qty_3 pl_1col_qty_bigtablets_4 pl_2col_qty_bigtablets_3 pl_3col_qty_bigtablets_2 pl_1col_qty_tablets_3 pl_1col_qty_phones_1 home_tabs2 pl_border_type2 45 14 12 pl_button_icon_no pl_button_qty2 pl_desc_no pl_reviews_no pl_availability_no hide_reference_no hide_reassurance_yes product_tabs1 menu_sep6 header_sep1 slider_full_width feat_cat_style2 feat_cat6 feat_cat_bigtablets4 feat_cat_tablets4 feat_cat_phones0 all_products_yes pl_colors_yes newsletter_info_yes stickycart_yes stickymenu_yes homeicon_no pl_man_no product_hide_man_no pl_ref_yes mainfont_Poppins bg_white standard_carusele not_logged display_slider"><div id="etsBAWhookDisplayCartGridBodyBefore1" style="display: none">
        <div class="ets_baw_display_banner  displaycartgridbodybefore1">
                                <img src="https://connexstore.co.za/img/ets_banneranywhere/2.png">
                </div>
<div class="clearfix"></div><div class="ets_baw_display_banner  displaycartgridbodybefore1">
                                <img src="https://connexstore.co.za/img/ets_banneranywhere/payment_banners-ozow-1024x136cssa_eaeono.jpg">
                </div>
...
</div><div id="_desktop_user_info"><div class="user-info">
      ...
      <ul class="top-menu container" data-depth="4">
							...
							<li class="category" id="category-370">
								  <a class="dropdown-item sf-with-ul" href="https://connexstore.co.za/370-components" data-depth="2">
										  					  					  <span class="float-xs-right hidden-md-up">
						<span data-target="#top_sub_menu_18170" data-toggle="collapse" class="navbar-toggler collapse-icons">
						  <i class="material-icons add"></i>
						  <i class="material-icons remove"></i>
						</span>
					  </span>
				  				  ...
				  				  <div class="collapse" id="top_sub_menu_18170">
      ...
      <ul class="top-menu container" data-depth="3">
						...
						<span data-target="#top_sub_menu_8875" data-toggle="collapse" class="navbar-toggler collapse-icons">
						  ...
						  <i class="material-icons remove"></i>
				  				  ...
				  				  <div class="collapse" id="top_sub_menu_8875">
      ...
      <ul class="top-menu container" data-depth="2">
							...
							<li class="category" id="category-386">
								  <a class="dropdown-item sf-with-ul" href="https://connexstore.co.za/386-printers" data-depth="2">
										  					  					  <span class="float-xs-right hidden-md-up">
						<span data-target="#top_sub_menu_12323" data-toggle="collapse" class="navbar-toggler collapse-icons">
						  <i class="material-icons add"></i>
						  <i class="material-icons remove"></i>
						</span>
					  </span>
				  				  ...
				  				  <div class="collapse" id="top_sub_menu_12323">
      ...
      <ul class="top-menu container" data-depth="3">
						...
						<span data-target="#top_sub_menu_93982" data-toggle="collapse" class="navbar-toggler collapse-icons">
						  ...
						  <i class="material-icons remove"></i>
				  				  ...
				  				  <div class="popover sub-menu js-sub-menu collapse" id="top_sub_menu_93982">
      ...
      <ul class="top-menu container" data-depth="1">
						...
						<span data-target="#top_sub_menu_58249" data-toggle="collapse" class="navbar-toggler collapse-icons">
						  ...
						  <i class="material-icons remove"></i>
				  				  ...
				  				  <div class="popover sub-menu js-sub-menu collapse" id="top_sub_menu_58249">
      ...
      <ul class="top-menu container" data-depth="1">
						...
						<span data-target="#top_sub_menu_67464" data-toggle="collapse" class="navbar-toggler collapse-icons">
						  ...
						  <i class="material-icons remove"></i>
				  				  ...
				  				  <div class="popover sub-menu js-sub-menu collapse" id="top_sub_menu_67464">
      ...
      <ul class="top-menu container" data-depth="2">
						...
						<span data-target="#top_sub_menu_88619" data-toggle="collapse" class="navbar-toggler collapse-icons">
						  ...
						  <i class="material-icons remove"></i>
				  				  ...
				  				  <div class="popover sub-menu js-sub-menu collapse" id="top_sub_menu_88619">
  ...
  <section id="main">
   <div class="cart-grid row">
      ...
      <!--<div class="cart-grid-body ">-->
        <div class="ets_baw_display_banner  displaycartgridbodybefore1 col-xs-12 col-lg-8">
                               <!--<img src="https://connexstore.co.za/img/ets_banneranywhere/2.png">-->
                </div>
<div class="clearfix"></div><div class="ets_baw_display_banner  displaycartgridbodybefore1">
                               <!-- <img src="https://connexstore.co.za/img/ets_banneranywhere/payment_banners-ozow-1024x136cssa_eaeono.jpg">
...
<div class="clearfix"></div>
  ...
  <div class="cart-overview js-cart" data-refresh-url="//connexstore.co.za/cart?ajax=1&amp;action=refresh">
...
<div class="estimated_delivery_date" style="display: block;">
    <div class="estimated_delivery_date_wrapper">
        <div class="estimated_delivery_date_icon">
            <span class="icon-wrapper circle-shape" style="background-color:#FFFFFF"><i class="icon nkmdeliverydate-icon-truck1" style="color:#5F5F5F"></i></span>
        </div>
        <div class="estimated_delivery_date_content">
            Expected delivery date : <span class="estimated_delivery_date_value">30/05/2023</span>
        </div>
    </div>
</div>
                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <?php
                                 ...
                                 echo"<tr>";
                                 echo"<td class='align-middle'><img src='images/$image' alt='' style='width: 50px;'>$name</td>";
                                 echo"<td class='align-middle'>R  $price.00</td>";
                                 echo"<td class='align-middle'>R  $total.00</td>";
                            ...
                            <form action='cart.php' method='post'>
                                <input type="number" name="update_quantity" min="1" value="<?php echo['quantity'];?>">
                                    <input type="submit" value="update" name="update_update_btn" class="btn btn-sm btn-primary">
                                    </form>
                            </td>
<!--<input type="remove" value="delete" name="update_update_btn" class="btn btn-sm btn-primary">
<a href="cart.php?remove=<?php echo['id'];?>" onclick="return confirm('remove item from cart?')"><i class="fa fa-times"></i>delete</a></td>-->
                            <td class="align-middle">
                            
                                <form action='cart.php' method='post'>
                                    <input type='hidden' name='id' value="<?php echo $key?>">
                                    <input type="submit" value="delete" name="remove" class="btn btn-sm btn-primary">
                                    <!--<a href="userdisplay.php?delete=" class="btn btn-sm btn-primary" onclick="return confirm('are you sure you want to delete this?');"><i class="fa fa-times"></i>delete</a>-->
                                </form>
                            </td>
                        <?php
                        };
...
<div class="cart-detailed-totals">
  ...
  <div class="card-block">
    ...
    <?php
          ...
          <span class="value">R<?php echo $total * $update_value; ?></span>
        </div>
                                          </div>
                        <div class="card-block">
  ...
  <div class="checkout text-sm-center card-block"><a class="label" href="checkout.php?quantity=<?php echo $update_value;?>" >
	...
	<div class="fb-page fb_iframe_widget" data-href="https://web.facebook.com/profile.php?id=100090032495161" data-width="500" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" fb-xfbml-state="rendered" fb-iframe-plugin-query="adapt_container_width=true&amp;app_id=&amp;container_width=292&amp;hide_cover=false&amp;href=https%3A%2F%2Fweb.facebook.com%2Fprofile.php%3Fid%3D100090032495161&amp;locale=en_US&amp;sdk=joey&amp;show_facepile=true&amp;small_header=false&amp;width=500"><span style="vertical-align: bottom; width: 292px; height: 130px;"><iframe name="fb8682d3c90814" width="500px" height="1000px" data-testid="fb:page Facebook Social Plugin" title="fb:page Facebook Social Plugin" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" src="https://www.facebook.com/v2.6/plugins/page.php?adapt_container_width=true&amp;app_id=&amp;channel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df26d70f0be55fe4%26domain%3Dconnexstore.co.za%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fconnexstore.co.za%252Ff4b518eaa538c8%26relation%3Dparent.parent&amp;container_width=292&amp;hide_cover=false&amp;href=https%3A%2F%2Fweb.facebook.com%2Fprofile.php%3Fid%3D100090032495161&amp;locale=en_US&amp;sdk=joey&amp;show_facepile=true&amp;small_header=false&amp;width=500" style="border: none; visibility: visible; width: 292px; height: 130px;" class=""></iframe></span></div>
</div>
...
<script type="text/javascript">
				...
				$(window).on("unload", function (e) {
					...
					pagetime.append("id_connections", "222261");
					pagetime.append("id_page", "290");
					pagetime.append("time_start", "2023-05-22 14:01:06");
					pagetime.append("token", "63559e9ec885cec77960f06e25cdbeab38cc7a7b");
