...
if(isset($_POST['update_info'])){
	...
	$update_Fullname = $update_name . "" . $update_lastname;
  
	$update_query = mysqli_query($conn, "UPDATE `register` SET Fullname = '$update_Fullname', name = '$update_name', lastname = '$update_lastname', email = '$update_email', password = '$update_password' WHERE id = '$id'");
  }
?>
...
<link rel="font" rel="preload" as="font" type="font/woff2" crossorigin href="https://connexstore.co.za/themes/AngarTheme/assets/css/fonts/material_icons.woff2" />
  ...
  <script src="https://embed.tawk.to/_s/v4/app/642b759ae8c/js/twk-main.js" charset="UTF-8" crossorigin="*"></script><script src="https://embed.tawk.to/_s/v4/app/642b759ae8c/js/twk-vendor.js" charset="UTF-8" crossorigin="*"></script><script src="https://embed.tawk.to/_s/v4/app/642b759ae8c/js/twk-chunk-vendors.js" charset="UTF-8" crossorigin="*"></script><script src="https://embed.tawk.to/_s/v4/app/642b759ae8c/js/twk-chunk-common.js" charset="UTF-8" crossorigin="*"></script><script src="https://embed.tawk.to/_s/v4/app/642b759ae8c/js/twk-runtime.js" charset="UTF-8" crossorigin="*"></script><script src="https://embed.tawk.to/_s/v4/app/642b759ae8c/js/twk-app.js" charset="UTF-8" crossorigin="*"></script><script src="https://connect.facebook.net/en_US/sdk.js?hash=2da05fb08e877df6c33fe459d32e9807" async="" crossorigin="anonymous"></script><script type="text/javascript" async="" src="//connexstorecoza.api.oneall.com/socialize/library.js"></script><script id="facebook-jssdk" src="//connect.facebook.net/en_EN/sdk.js#xfbml=1&amp;version=v2.6"></script><script async="" src="https://embed.tawk.to/5dc51109d96992700fc66f99/default" charset="UTF-8" crossorigin="*"></script><script async="" src="https://www.googletagmanager.com/gtm.js?id=AW-749461096"></script><script async="" src="https://www.google-analytics.com/analytics.js"></script><script type="text/javascript">
        ...
        var roja45quotationspro_controller = "https:\/\/connexstore.co.za\/module\/roja45quotationspro\/QuotationsProFront?token=af5a09a4ed78089123b039c834085c8d";
...
clip:auto !important;
color-scheme:light !important;}#efupqvqfqll81685006263213.widget-hidden {display: none !important;}#efupqvqfqll81685006263213.widget-visible {display: block !important;}
@media print{
 #efupqvqfqll81685006263213.widget-visible { 
display: none !important;
 }
}</style><script src="https://cdn.jsdelivr.net/emojione/2.2.7/lib/js/emojione.min.js" type="text/javascript" async="" defer=""></script><script src="https://cdn.jsdelivr.net/emojione/2.2.7/lib/js/emojione.min.js" type="text/javascript" async="" defer=""></script><style type="text/css">@keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}@-moz-keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}@-webkit-keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}#wko54s00il3g1685006263321.open{animation : tawkMaxOpen .25s ease!important;}@keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}@-moz-keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}@-webkit-keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}#wko54s00il3g1685006263321.closed{animation: tawkMaxClose .25s ease!important}</style></head>

  <body id="identity" class="lang-en country-za currency-zar layout-full-width page-identity tax-display-enabled page-customer-account live_edit_0   ps_178
...
<!-- /Block search module TOP -->
      ...
      <ul class="top-menu container" data-depth="2">
						...
						<span data-target="#top_sub_menu_64994" data-toggle="collapse" class="navbar-toggler collapse-icons">
						  ...
						  <i class="material-icons remove"></i>
				  				  ...
				  				  <div class="collapse" id="top_sub_menu_64994">
      ...
      <ul class="top-menu container" data-depth="3">
						...
						<span data-target="#top_sub_menu_12846" data-toggle="collapse" class="navbar-toggler collapse-icons">
						  ...
						  <i class="material-icons remove"></i>
				  				  ...
				  				  <div class="popover sub-menu js-sub-menu collapse" id="top_sub_menu_12846">
      ...
      <ul class="top-menu container" data-depth="1">
						...
						<span data-target="#top_sub_menu_36214" data-toggle="collapse" class="navbar-toggler collapse-icons">
						  ...
						  <i class="material-icons remove"></i>
				  				  ...
				  				  <div class="popover sub-menu js-sub-menu collapse" id="top_sub_menu_36214">
      ...
      <ul class="top-menu container" data-depth="1">
						...
						<span data-target="#top_sub_menu_62112" data-toggle="collapse" class="navbar-toggler collapse-icons">
						  ...
						  <i class="material-icons remove"></i>
				  				  ...
				  				  <div class="popover sub-menu js-sub-menu collapse" id="top_sub_menu_62112">
      ...
      <ul class="top-menu container" data-depth="2">
						...
						<span data-target="#top_sub_menu_19331" data-toggle="collapse" class="navbar-toggler collapse-icons">
						  ...
						  <i class="material-icons remove"></i>
				  				  ...
				  				  <div class="popover sub-menu js-sub-menu collapse" id="top_sub_menu_19331">
	...
	<ul class="user_info hidden-md-up">
			...
			<li><a href="./User/user.php" title="View my customer account" rel="nofollow">Your account</a></li>

			<li><a id="./User/information.php" href="https://connexstore.co.za/identity">Information</a></li>
	...
	<div class="hidden-sm-down">
		<span class="welcome">Welcome,</span>
					<a class="account" href="https://connexstore.co.za/my-account" title="View my customer account" rel="nofollow"><?php echo $email; ?></a>
  ...
  <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
        ...
        <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
          <a itemprop="item" href="information.php">
            <span itemprop="name">Your personal information</span>
          </a>
...
<form action="" id="customer-form" class="js-customer-form" method="post">
  ...
  <div class="form-group row ">
    ...
    <div class="col-md-6">
          ...
          <input class="form-control" name="lastname" type="text" value="<?php echo $lastname; ?>"  required="">
                      <span class="form-control-comment">
              Only letters and the dot (.) character, followed by a space, are allowed.
            </span>
  ...
  <div class="form-group row ">
    ...
    <div class="col-md-6">
          ...
          <div class="input-group js-parent-focus">
            <input class="form-control js-child-focus js-visible-password" name="password" type="password" value="<?php echo $pass; ?>"pattern=".{5,}" required="">
  ...
  <footer class="form-footer clearfix">
      <input type="hidden" name="submitCreate" value="1">
        ...
        <button class="btn btn-primary form-control-submit float-xs-right" data-link-action="save-customer" name="update_info" type="submit">
          Save
        </button>
  ...
  <a href="user.php" class="account-link">
  ...
  <div class="container">
    ...
    <div class="row">
			...
			<div class="col-md-3 links wrapper">
		  		  ...
		  		  <div class="title clearfix hidden-md-up" data-target="#footer_sub_menu_8249" data-toggle="collapse">
		  ...
		  <ul id="footer_sub_menu_8249" class="collapse">
						  <li>
...
<div id="block_myaccount_infos" class="col-md-3 links wrapper">
    ...
    <a class="text-uppercase" href="user.php" rel="nofollow">
      Your account
    </a>
  </div>
  ...
  <ul class="account-list collapse" id="footer_account_list">
            <li>
          <a href="information.php" title="Personal info" rel="nofollow">
            Personal info
          </a>
        </li>
            <li>
...
<script type="text/javascript">
				...
				$(window).on("unload", function (e) {
					...
					pagetime.append("id_connections", "230875");
					pagetime.append("id_page", "1991");
					pagetime.append("time_start", "2023-05-25 11:17:40");
					pagetime.append("token", "2d551a55fb9142f4390fbba9861a849d3ed1cac6");
