...
<div class="hidden-sm-down">
	<span class="welcome">Welcome,</span>
				<a class="account" href="user.php" title="Log in to your customer account" rel="nofollow"><?php echo $fullname; ?></a>
...
<div class="menu js-top-menu position-static hidden-sm-down" id="_desktop_top_menu">
  ...
  <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
        ...
        <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
          <a itemprop="item" href="./User/user.php">
...
<aside id="notifications">
  ...
  <div class="row">
    <div class="links">
      ...
      <a class="col-lg-4 col-md-6 col-sm-6 col-xs-12" id="identity-link" href="information.php">
        <span class="link-item">
          ...
          Information
              ...
              <a class="col-lg-4 col-md-6 col-sm-6 col-xs-12" id="discounts-link" href="../cart.php">
          <span class="link-item">
            <i class="material-icons"></i>
            Your Cart
          </span>
        ...
        <a class="col-lg-4 col-md-6 col-sm-6 col-xs-12" id="wishlist-link" href="../index2.php">
  <span class="link-item">
