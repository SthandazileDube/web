...
<div class="hidden-sm-down">
	<span class="welcome">Welcome,</span>
				<a class="account" href="reg.php" title="Log in to your customer account" rel="nofollow">Signup</a>

		<span class="or">or</span>

		<a class="account" href="login.php" title="Log in to your customer account" rel="nofollow">Signin</a>
		</div>
								...
								<div class="blockcart cart-preview inactive">
									<div class="header">
										<div class="cart_index_title">
											<a class="cart_link" rel="nofollow" href="login.php">
                                                        ...
                                                        <div class="product-left">
                                                            <div class="product-image-container">
                                                                ...
                                                                <a href="#" class="thumbnail product-thumbnail">
                                                                    <img src="images/wahoo-fitness-elemnt-bolt-bike-computer-unisex-adult-black.jpg" alt="Wahoo Fitness ELEMNT Bolt..." data-full-size-image-url="https://connexstore.co.za/12075-large_default/wahoo-fitness-elemnt-bolt-bike-computer-unisex-adult-black.jpg" width="259" height="259">
                                                                </a>
                                                            ...
                                                            <div class="product-bottom">
                                                                ...
                                                                <div class="button-container">
                                                                    ...
                                                                    <form action="load-page.php" method="post">
                                                                        ...
                                                                        <input type="hidden" name="id" value="124578">

                                                                            <?php 
                                                                                if(isset($_SESSION['p124578'])){
                                                                                    echo("
                                                    ...
                                                    <div class="thumbnail-container">
                                                        ...
                                                        <div class="product-right">
                                                            ...
                                                            <div class="product-bottom">
																...
																<form action="load-page.php" method="post">
                                                                        <!-- <input type="hidden" name="token" value="3a6692178813dd428366c5889a7a5c84"> -->
                                                                        <input type="hidden" name="id" value="135790">

                                                                            <?php 
                                                                                if(isset($_SESSION['p135790'])){
                                                                                    echo("
                                                                                    <button class='btn add-to-cart' name='add_to_cart' type='button'>
                                                                                     <i class='material-icons shopping-cart'></i>
                                                                                       In Cart
                                                    ...
                                                    <div class="thumbnail-container">
                                                        ...
                                                        <div class="product-left">
                                                            <div class="product-image-container">
                                                                ...
                                                                <a href="#" class="thumbnail product-thumbnail">
                                                                    <img src="./images/acer-predator-gd711-projector-1450-ansi-dlp-2160p-3840x2160-3d-black.jpg" alt="ACER PREDATOR GD711..." data-full-size-image-url="https://connexstore.co.za/12062-large_default/acer-predator-gd711-projector-1450-ansi-dlp-2160p-3840x2160-3d-black.jpg" width="259" height="259">
                                                                </a>
                                                        ...
                                                        <div class="product-right">
                                                            ...
                                                            <div class="product-bottom">
																...
																<form action="load-page.php" method="post">
                                                                        <!-- <input type="hidden" name="token" value="3a6692178813dd428366c5889a7a5c84"> -->
                                                                        <input type="hidden" name="id" value="786940">

                                                                            <?php 
                                                                                if(isset($_SESSION['p786940'])){
                                                                                    echo("
                                                                                    <button class='btn add-to-cart' name='add_to_cart' type='button'>
                                                                                     <i class='material-icons shopping-cart'></i>
                                                                                       In Cart
                                                    ...
                                                    <div class="thumbnail-container">
                                                        ...
                                                        <div class="product-right">
                                                            ...
                                                            <div class="product-bottom">
																...
																<form action="load-page.php" method="post">
                                                                        <!-- <input type="hidden" name="token" value="3a6692178813dd428366c5889a7a5c84"> -->
                                                                        <input type="hidden" name="id" value="234670">

                                                                            <?php 
                                                                                if(isset($_SESSION['p234670'])){
                                                                                    echo("
                                                                                    <button class='btn add-to-cart' name='add_to_cart' type='button'>
                                                                                     <i class='material-icons shopping-cart'></i>
                                                                                       In Cart
                                                        ...
                                                        <div class="product-right">
                                                            ...
                                                            <div class="product-bottom">
                                                                ...
                                                                <div class="button-container">
                                                                   ...
                                                                   <form action="load-page.php" method="post">
                                                                        <!-- <input type="hidden" name="token" value="3a6692178813dd428366c5889a7a5c84"> -->
                                                                        <input type="hidden" name="id" value="453218">


                                                                        <?php 
                                                                                if(isset($_SESSION['p453218'])){
                                                                                    echo("
                                                                                    <button class='btn add-to-cart' name='add_to_cart' type='button'>
                                                                                     <i class='material-icons shopping-cart'></i>
                                                                                       In Cart
                                                    ...
                                                    <div class="thumbnail-container">
                                                        ...
                                                        <div class="product-left">
                                                            <div class="product-image-container">
                                                                ...
                                                                <a href="#" class="thumbnail product-thumbnail">
                                                                    <img src="./images/acer-x1526hk-projector-brightness-4000-lm-contrast-10000-1-resolution-wuxga-display-type-dlp-weight-2-6kg-p177948-177206_image.png" alt="ACER compatible PL1520i DLP..." data-full-size-image-url="https://connexstore.co.za/12043-large_default/acer-compatible-pl1520i-dlp-1080p-4000lm.jpg" width="259" height="259">
                                                                </a>
                                                        ...
                                                        <div class="product-right">
                                                            ...
                                                            <div class="product-bottom">
                                                                ...
                                                                <form action="load-page.php" method="post">
                                                                        <!-- <input type="hidden" name="token" value="3a6692178813dd428366c5889a7a5c84"> -->
                                                                        <input type="hidden" name="id" value="763942">


                                                                        <?php 
                                                                                if(isset($_SESSION['763942'])){
                                                                                    echo("
                                                                                    <button class='btn add-to-cart' name='add_to_cart' type='button'>
                                                                                     <i class='material-icons shopping-cart'></i>
                                                                                       In Cart
                                                    ...
                                                    <div class="thumbnail-container">
                                                        ...
                                                        <div class="product-left">
                                                            <div class="product-image-container">
                                                                ...
                                                                <a href="#" class="thumbnail product-thumbnail">
                                                                    <img src="./images/bose-smart-soundbar-900-with-dolby-atmos-and-alexa-voice-assistant-black.jpg" alt="Bose Smart Soundbar 900..." data-full-size-image-url="https://connexstore.co.za/11565-large_default/bose-smart-soundbar-900-with-dolby-atmos-and-alexa-voice-assistant-black.jpg" width="259" height="259">
                                                                </a>
                                                        ...
                                                        <div class="product-right">
                                                            ...
                                                            <div class="product-bottom">
                                                                ...
                                                                <form action="load-page.php" method="post">
                                                                        <!-- <input type="hidden" name="token" value="3a6692178813dd428366c5889a7a5c84"> -->
                                                                        <input type="hidden" name="id" value="531289">


                                                                        <?php 
                                                                                if(isset($_SESSION['p531289'])){
                                                                                    echo("
                                                                                    <button class='btn add-to-cart' name='add_to_cart' type='button'>
                                                                                     <i class='material-icons shopping-cart'></i>
                                                                                       In Cart
                                                    ...
                                                    <div class="thumbnail-container">
                                                        ...
                                                        <div class="product-left">
                                                            <div class="product-image-container">
                                                                ...
                                                                <a href="#" class="thumbnail product-thumbnail">
                                                                    <img src="./images/pioneer-cdj-350-multi-player-usbcd-refurbished.jpg" alt="Pioneer CDJ 350 Multi..." data-full-size-image-url="https://connexstore.co.za/11814-large_default/pioneer-cdj-350-multi-player-usbcd-refurbished.jpg" width="259" height="259">
                                                                </a>
                                                        ...
                                                        <div class="product-right">
                                                            ...
                                                            <div class="product-bottom">
                                                                ...
                                                                <form action="load-page.php" method="post">
                                                                    <!-- <input type="hidden" name="token" value="3a6692178813dd428366c5889a7a5c84"> -->
                                                                    <input type="hidden" name="id" value="908643">


                                                                    <?php 
                                                                            if(isset($_SESSION['p908643'])){
                                                                                echo("
                                                                                <button class='btn add-to-cart' name='add_to_cart' type='button'>
                                                                                <i class='material-icons shopping-cart'></i>
                                                                                In Cart
                                                    ...
                                                    <div class="thumbnail-container">
                                                        ...
                                                        <div class="product-left">
                                                            <div class="product-image-container">
                                                                ...
                                                                <a href="#" class="thumbnail product-thumbnail">
                                                                    <img src="./images/pico4--2_2df65917-b6fb-4312-9a56-627d265458cc_800x.webp" alt="PICO 4 All-in-One VR 128GB..." data-full-size-image-url="https://connexstore.co.za/11378-large_default/pico-4-all-in-one-vr-128gb-headset.jpg" width="259" height="259">
                                                                </a>
                                                        ...
                                                        <div class="product-right">
                                                            ...
                                                            <div class="product-bottom">
                                                                ...
                                                                <form action="load-page.php" method="post">
                                                                    <!-- <input type="hidden" name="token" value="3a6692178813dd428366c5889a7a5c84"> -->
                                                                    <input type="hidden" name="id" value="549027">


                                                                    <?php 
                                                                            if(isset($_SESSION['p549027'])){
                                                                                echo("
                                                                                <button class='btn add-to-cart' name='add_to_cart' type='button'>
                                                                                <i class='material-icons shopping-cart'></i>
                                                                                In Cart
                                                    ...
                                                    <div class="thumbnail-container">
                                                        ...
                                                        <div class="product-left">
                                                            <div class="product-image-container">
                                                                ...
                                                                <a href="#" class="thumbnail product-thumbnail">
                                                                    <img src="./images/cdj-2000_thumb.jpg" alt="Pioneer CDJ 350 Multi..." data-full-size-image-url="https://connexstore.co.za/5951-large_default/pioneer-cdj-350-multi-player-usbcd-refurbished.jpg" width="259" height="259">
                                                                </a>
                                                        ...
                                                        <div class="product-right">
                                                            ...
                                                            <div class="product-bottom">
                                                                ...
                                                                <form action="load-page.php" method="post">
                                                                    <!-- <input type="hidden" name="token" value="3a6692178813dd428366c5889a7a5c84"> -->
                                                                    <input type="hidden" name="id" value="987452">


                                                                    <?php 
                                                                            if(isset($_SESSION['p987452'])){
                                                                                echo("
                                                                                <button class='btn add-to-cart' name='add_to_cart' type='button'>
                                                                                <i class='material-icons shopping-cart'></i>
                                                                                In Cart
                                                    ...
                                                    <div class="thumbnail-container">
                                                        ...
                                                        <div class="product-left">
                                                            <div class="product-image-container">
                                                                ...
                                                                <a href="#" class="thumbnail product-thumbnail">
                                                                    <img src="./images/800x.png" alt="PICO 4 All-in-One VR 128GB..." data-full-size-image-url="https://connexstore.co.za/11378-large_default/pico-4-all-in-one-vr-128gb-headset.jpg" width="259" height="259">
                                                                </a>
                                                        ...
                                                        <div class="product-right">
                                                            ...
                                                            <div class="product-bottom">
                                                                ...
                                                                <form action="load-page.php" method="post">
                                                                    <!-- <input type="hidden" name="token" value="3a6692178813dd428366c5889a7a5c84"> -->
                                                                    <input type="hidden" name="id" value="123897">


                                                                    <?php 
                                                                            if(isset($_SESSION['p123897'])){
                                                                                echo("
                                                                                <button class='btn add-to-cart' name='add_to_cart' type='button'>
                                                                                <i class='material-icons shopping-cart'></i>
                                                                                In Cart
                                                    ...
                                                    <div class="thumbnail-container">
                                                        ...
                                                        <div class="product-left">
                                                            <div class="product-image-container">
                                                                ...
                                                                <a href="#" class="thumbnail product-thumbnail">
                                                                    <img src="./images/charger.jpg" alt="Smatree Meta Oculus Quest 2..." data-full-size-image-url="https://connexstore.co.za/9657-large_default/smatree-meta-quest-2-oculus-quest-2-charging-dock-charge-oculus-quest-2-vr-headset-and-touch-controller.jpg" width="259" height="259">
                                                                </a>
                                                        ...
                                                        <div class="product-right">
                                                            ...
                                                            <div class="product-bottom">
                                                                ...
                                                                <form action="load-page.php" method="post">
                                                                    <!-- <input type="hidden" name="token" value="3a6692178813dd428366c5889a7a5c84"> -->
                                                                    <input type="hidden" name="id" value="452691">


                                                                    <?php 
                                                                            if(isset($_SESSION['p452691'])){
                                                                                echo("
                                                                                <button class='btn add-to-cart' name='add_to_cart' type='button'>
                                                                                <i class='material-icons shopping-cart'></i>
                                                                                In Cart
                                                    ...
                                                    <div class="thumbnail-container">
                                                        ...
                                                        <div class="product-left">
                                                            <div class="product-image-container">
                                                                ...
                                                                <a href="#" class="thumbnail product-thumbnail">
                                                                    <img src="images/<?php echo $fetch_product['image'];?>" alt="Wahoo Fitness ELEMNT Bolt..." data-full-size-image-url="https://connexstore.co.za/12075-large_default/wahoo-fitness-elemnt-bolt-bike-computer-unisex-adult-black.jpg" width="259" height="259">
                                                                </a>
                                                        ...
                                                        <div class="product-right">
                                                            <div class="product-description">
                                                                ...
                                                                <p class="pl_manufacturer">
                                                                    Brand:
                                                                    <a href="#" title="Wahoo"><strong><?php echo $fetch_product['name'];?></strong></a>
                                                                </p>


                                                                <h3 class="h3 product-title"><a href="#"><?php echo $fetch_product['description']?></a></h3>
                                                            ...
                                                            <div class="product-bottom">
                                                                ...
                                                                <div class="product-price-and-shipping">
                                                                    ...
                                                                    <span class="sr-only">Price</span>
                                                                    <span class="price">R<?php echo $fetch_product['price'];?>.00</span>
